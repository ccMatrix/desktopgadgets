...
function gameKeyDown() {
  ...
  switch (event.keyCode) {
    case options.getValue("keyLeft"): moveleft();
						break;
		case options.getValue("keyRight"): moveright();
						break;
		case options.getValue("keyRotate"): rotate();
						break;
		case options.getValue("keyDown"): movedown();
						break;
		case options.getValue("keyFall"): fall();
						break;
  }
}
