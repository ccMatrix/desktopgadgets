========================================================================
    KONSOLENANWENDUNG: VolumeControlVista-Projektübersicht
========================================================================

Diese VolumeControlVista-Anwendung wurde vom Anwendungs-Assistenten
für Sie erstellt.  

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien,
aus denen Ihre VolumeControlVista–Anwendung besteht.


VolumeControlVista.vcproj
...
StdAfx.h, StdAfx.cpp
    ...
    mit dem Namen "VolumeControlVista.pch" und eine 
